...
@section('content')
    ...
    @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input name="cpf_paciente" type="text" class="form-control" id="inputCPF3" pattern="[0-9]{3}.[0-9]{3}.[0-9]{3}-[0-9]{2}"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input name="telefone_paciente" type="text" class="form-control" id="inputTelefone" 
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input name="peso_paciente" type="number" min="0.0" max="1000" step="0.1" class="form-control" id="inputPeso" placeholder="Peso">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputAltura" class="col-sm-2 col-form-label">Altura</label>
            <div class="col-sm-10">
              <input name="altura_paciente" type="number" min="0.00" max="3.00" step="0.10" class="form-control" id="inputAltura" placeholder="Altura">
            </div>
        </div>
        <div class="form-group row">
            <label for="inputIMC" class="col-sm-2 col-form-label">IMC</label>
            <div class="col-sm-10">
              <input name="imc_paciente" type="number" min="0.0" max="1000" step="0.1" class="form-control" id="inputIMC" placeholder="IMC">
            </div>
        </div>
