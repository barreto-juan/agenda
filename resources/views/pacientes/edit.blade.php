...
@section('title', 'Atualizar Dados de Paciente')
@section('content')
@section('item', 'Atualizar Dados de Paciente')
    <hr>
    ...
    @method('PUT')
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input name="cpf_paciente" value="{{$paciente->cpf_paciente}}" type="text" class="form-control" id="inputCPF3" placeholder="CPF (111.222.333-44)">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input name="telefone_paciente" value="{{$paciente->telefone_paciente}}" type="text" class="form-control" id="inputTelefone" placeholder="Telefone (XX) XXXXX-XXXX">
            </div>
        </div>
        <div class="form-group row">
